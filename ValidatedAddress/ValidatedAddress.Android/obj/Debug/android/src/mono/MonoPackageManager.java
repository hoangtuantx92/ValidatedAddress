...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "ValidatedAddress.Android.dll" comes first in this list. */
		"ValidatedAddress.Android.dll",
		"FormsViewGroup.dll",
		"ValidatedAddress.dll",
